...
import { Col, Row, Descriptions, Badge, Tag } from 'antd';
    ...
    <Row gutter={[8, 8]}>
      <Col span={24}>
        <Descriptions title="用例详情" bordered size="small">
          ...
          <Descriptions.Item label="请求方式" span={2}>
            {data.request_method}
          </Descriptions.Item>
          <Descriptions.Item label="用例状态" span={3}>
              ...
              <div style={{ textAlign: 'center' }}>
                {data.tag !== null
                  ? data.tag.split(',').map((v) => (
                      <Tag key={v} style={{ marginRight: 4 }} color="blue">
                        {v}
                      </Tag>
                    ))
                  : ''}
